...
useEffect(() => {
}, [imgValue1, imgValue2, imgValue3, imgValue4, imgValue5, imgValue6, imgValue7])
  return (
    <div className="Page">
      <div className="header">
        ...
        <div className="Hero">
          ...
          <button className="contact-btn" onClick={scrollToContact}>Contact Us Now</button>
        </div>
          ...
          <div className="products-container">
            ...
            <div className='floral-container'>
              ...
              <button className='btn-change-img' onClick={backImgArray6}>
                <img className='arrow-icon left-arrow' src={arrowFoward} alt='arrow back'></img>
              </button>
              <img src={img6Array[imgValue6]} className="card-img" alt="bouncy house"></img>
              <div className="overlay"></div>
              <button className='btn-change-img' type='button' onClick={imgFowardArray6}>
                <img className='arrow-icon' src={arrowFoward} alt='arrow back'></img>
              </button>
              </div>
              <h3 className="card-title">Custom Bouquets</h3>
              <p className='card-description'>A mix of beautiful flowers based on the color scheme of your choice
              </p>
              </div>
              </div>
              <div className="card">
              ...
              <img src={img7Array[imgValue7]} className="card-img" alt="bouncy house"></img>
              <div className="overlay"></div>
              <button className='btn-change-img' type='button' onClick={imgFowardArray7}>
                <img className='arrow-icon' src={arrowFoward} alt='arrow back'></img>
              </button>
              </div>
              <h3 className="card-title">Ramo Buchon</h3>
              <p className='card-description'>A trendy style of huge bouquets made of roses, these bouquets are over top customized with all sorts of things such as LEDS, Lights, glitter, chocolates, or even money.
              </p>
              </div>
              </div>
            </div>
            ...
            <div className='bouncy-container'>
              ...
              <img src={img1Array[imgValue1]} className="card-img" alt="bouncy house"></img>
              <div className="overlay"></div>
              <button className='btn-change-img' type='button' onClick={imgFowardArray1}>
                <img className='arrow-icon' src={arrowFoward} alt='arrow back'></img>
              </button>
              </div>
              <h3 className="card-title">Shark Slide</h3>
              <p className='card-description'>Our best-seller, with 3D sharks and dolphins, realistic graphics, and a wide water slide fitting up to 2 people at a time but that is not all a 9x10 pool fitting up to 10 people
                <br></br>
                <br></br>
                8 hours: $200 <br></br>
                24 hours: $375<br></br>
              ...
              <img src={img2Array[imgValue2]} className="card-img" alt="bouncy house"></img>
              <div className="overlay"></div>
              <button className='btn-change-img' type='button' onClick={imgFowardArray2}>
                <img className='arrow-icon' src={arrowFoward} alt='arrow back'></img>
              </button>
              </div>
              <h3 className="card-title">Beach Paradise</h3>
              <p className='card-description'>Our fun and fasy slide with a small pool fits up to 5 people! This water slide will give you the perfect summer experience.
                <br></br>
                <br></br>
                8 hours: $200<br></br>
                24 hours: $250<br></br>
              ...
              <img src={img3Array[imgValue3]} className="card-img" alt="bouncy house"></img>
              <div className="overlay"></div>
              <button className='btn-change-img' type='button' onClick={imgFowardArray3}>
                <img className='arrow-icon' src={arrowFoward} alt='arrow back'></img>
              </button>
              </div>
              <h3 className="card-title">Spidey Bounce House</h3>
              <p className='card-description'>This is a bouncy house that your kids will absolutely love.
                <br></br>
                <br></br>
                6 hours: $150<br></br>
                8 hours: $180<br></br>
              ...
              <img src={img4Array[imgValue4]} className="card-img" alt="bouncy house"></img>
              <div className="overlay"></div>
              <button className='btn-change-img' type='button' onClick={imgFowardArray4}>
                <img className='arrow-icon' src={arrowFoward} alt='arrow back'></img>
              </button>
              </div>
              <h3 className="card-title">Magical Carousel</h3>
              <p className='card-description'>Have you ever seen a bouncy house that is beautiful? only with Serra's birthdays can you book this creative and artistic unit.
                <br></br>
                <br></br>
                Size: 14x14
              </p>
            ...
            <div className='pinatas-container'>
              ...
              <img src={img5Array[imgValue5]} className="card-img" alt="bouncy house"></img>
              <div className="overlay"></div>
              <button className='btn-change-img' type='button' onClick={imgFowardArray5}>
                <img className='arrow-icon' src={arrowFoward} alt='arrow back'></img>
              </button>
              </div>
              <p className='card-description'>What's better than cake at a party? A piñata, of course! We bring your vision to life with our custom-made creations, meticulously handcrafted to perfection.
              </p>
              </div>
              </div>
            </div>
        ...
        <div className="About-us">
          ...
          <p className="about-us-paragraph">Serra&#8217;s Birthdays, a family-owned business since 2022, specializes in making every event feel extraordinary. From bouncy houses to floral arrangements, we bring your vision to life with joy, celebration, and excitement.</p>
          <p className="about-us-paragraph">Kellen Serra: With deep roots in Nashville and a lifelong passion for celebrations, I've been immersed in this field for many years. Raised by a mother who supported our family by crafting handmade piñatas, I inherited her love for creativity and party decor. Inspired by a transformative trip to Mexico, I founded 'Serra&#8217;s Birthdays' to bring the vibrant essence of Mexican celebrations to Nashville. We offer a range of creative services, from balloon arches to bouncy houses, ensuring every event reflects the joy and richness of our culture. Thank you for considering us for your special occasions.</p>
        </div>
        <div className="Contact-us" id='contact'>
            ...
            <form className="contact-form" ref={formRef} onSubmit={sendEmail}>
              ...
              <div className="input-container">
                ...
                <textarea className="inquiry-input" type="text" id="inquiry" placeholder="value" required></textarea>
              </div>
              <button type="submit" className="submit-btn">Submit</button>
              <h5 className="contact-info">SerrasBirthdays@gmail.com <br></br> (615)810-1072</h5>
            </form>
        </div>
        <footer className="Footer">
          <div className="socials">
            <a href="https://www.instagram.com/serrasbirthdays/" className="social">
            <img src={instagramIcon} className="social-icon" alt="instagram icon"></img>
            <div className="white-background"></div>
            </a>
            <a href="https://www.facebook.com/SerrasBirthdays" className="social">
            <img src={facebookIcon} className="social-icon" alt="facebook icon"></img>
            <div className="white-background"></div>
            </a>
